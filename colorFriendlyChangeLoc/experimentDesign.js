...
const CONFIG = {
    stimuli: {
        ...
        POSSIBLE_COLORS: [
            'rgb(255, 193, 7)',   // Light Orange
            'rgb(0, 77, 64)',   // Green
            'rgb(171, 92, 200)',   // Light Purple
            'rgb(255, 255, 255)',// White
            'rgb(177, 202, 172)', // Light Green
            'rgb(246, 59, 131)', // Pink
            'rgb(102, 151, 8)', // Medium Green
            'rgb(114, 78, 169)', // Medium Purple
            'rgb(165, 251, 156)'      // Bright Green
        ],
    }
